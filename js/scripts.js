...
(function($) {
    ...
    function init_map() {
        if ($("#map-section").length) {
            ...
            var is_internetExplorer11 = navigator.userAgent.toLowerCase().indexOf('trident') > -1,
                markerIcon = (is_internetExplorer11) ? 'img/google-map-assets/map-icon-location.png' : 'img/google-map-assets/map-icon-location.svg',
                // we define here the style of the map

                mapStyles = [{
                    "featureType": "landscape",
                    "stylers": [{ "saturation": -100 }, { "lightness": 65 }, { "visibility": "on" }]
                }, { "featureType": "poi", "stylers": [{ "saturation": -100 }, { "lightness": 51 }, { "visibility": "simplified" }] }, { "featureType": "road.highway", "stylers": [{ "saturation": -100 }, { "visibility": "simplified" }] }, { "featureType": "road.arterial", "stylers": [{ "saturation": -100 }, { "lightness": 30 }, { "visibility": "on" }] }, { "featureType": "road.local", "stylers": [{ "saturation": -100 }, { "lightness": 40 }, { "visibility": "on" }] }, { "featureType": "transit", "stylers": [{ "saturation": -100 }, { "visibility": "simplified" }] }, { "featureType": "administrative.province", "stylers": [{ "visibility": "off" }] }, { "featureType": "water", "elementType": "labels", "stylers": [{ "visibility": "on" }, { "lightness": -25 }, { "saturation": -100 }] }, {
                    "featureType": "water",
    ...
    //             scrollwheel: false,
    //         });
    //         var map_address = $("#map-canvas").attr("data-address");
    ...
    //                         lat: latlng.lat(),
    //                         lng: latlng.lng(),
    //                         icon: "img/google-map-assets/map-icon-location.svg",
    //                         opacity: 0.9,
    //                         title: 'Eiffel Tower',
    //                         infoWindow: {
    ...
    function init_animsition() {
        ...
        // $("#page").css("animation-duration", "1.2s");
        // var x;
        // var anim_in = $("#page").data('animsition-in');
        // clearTimeout(x);
        // x = setTimeout(function() {
        //     $(".animsition-loading").remove();
        //     $("#page").addClass(anim_in);
        //     init_skillBars();
        // }, 10000);
        // var z;
        // clearTimeout(z);
