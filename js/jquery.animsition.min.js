      ...
      , i = {
        init: function(a) {
            ...
            i.settings = {
                timer: !1,
                data: {
                    inClass: "animsition-in",
                    inDuration: "animsition-in-duration",
                    outClass: "animsition-out",
        ...
        addOverlay: function(n) {
            t(n.overlayParentElement).prepend('<div class="' + n.overlayClass + '"><div class="' + $(".animsition").attr("data-loader-type") + '"></div><div class="page-loader-text">' + $(".animsition").attr("data-page-loader-text") + '</div></div>')
        },
        addLoading: function(n) {
            t(n.loadingParentElement).append('<div class="' + n.loadingClass + '"><div class="' + $(".animsition").attr("data-loader-type") + '"></div><div class="page-loader-text">' + $(".animsition").attr("data-page-loader-text") + '</div></div>')
        },
