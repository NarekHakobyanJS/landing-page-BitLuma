...
!function(t, e, i, s) {
    ...
    n.prototype.onDragMove = function(t) {
        ...
        o.x = ((o.x - e) % i + i) % i + e) : (e = this.coordinates(this.settings.rtl ? this.maximum() : this.minimum()),
    ...
    n.prototype.closest = function(e, i) {
        ...
        return this.settings.freeDrag || t.each(r, t.proxy(function(t, a) {
            return e > a - n && a + n > e ? s = t : this.op(e, "<", a) && this.op(e, ">", r[t + 1] || a - o) && (s = "left" === i ? t + 1 : t),
            -1 === s
        }, this)),
    ...
    n.prototype.normalize = function(e, i) {
        ...
        return !t.isNumeric(e) || 1 > n ? e = s : (0 > e || e >= n + o) && (e = ((e - o / 2) % n + n) % n + o / 2),
        e
    }
    ,
...
function(t, e, i) {
    ...
    s.prototype.play = function(e) {
        ...
        "youtube" === o.type ? i = '<iframe width="' + r + '" height="' + a + '" src="http://www.youtube.com/embed/' + o.id + "?autoplay=1&v=" + o.id + '" frameborder="0" allowfullscreen></iframe>' : "vimeo" === o.type && (i = '<iframe src="http://player.vimeo.com/video/' + o.id + '?autoplay=1" width="' + r + '" height="' + a + '" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>'),
...
function(t) {
    ...
    e.prototype.draw = function() {
        ...
        this._controls.$absolute.children().eq(t.inArray(this.current(), this._pages)).addClass("active").trigger("owlDotClassChange"))
    }
    ,
